...
const ModernNotifications = core.registerPlugin('ModernNotifications', {
    web: () => Promise.resolve().then(function () { return web; }).then((m) => new m.ModernNotificationsWeb()),
});

class ModernNotificationsWeb extends core.WebPlugin {
    constructor() {
        super(...arguments);
        this.notifications = [];
...
var web = /*#__PURE__*/Object.freeze({
    __proto__: null,
    ModernNotificationsWeb: ModernNotificationsWeb
});

exports.ModernNotifications = ModernNotifications;
